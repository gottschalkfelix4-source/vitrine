...
export function Playlistseite() {
  ...
  const fehlend = positionen.length - daten.anzahl_archiviert - verschwunden;
  const anteil = positionen.length ? daten.anzahl_archiviert / positionen.length : 0;
    ...
    <section className="playlist-seite">
      <aside className="playlist-uebersicht" aria-label="Über diese Playlist">
        <div className="playlist-cover">
          ...
          <span className="dauer playlist-anzahl"><Icon name="playlist" size={16} />{positionen.length} Videos</span>
        </div>
        <div className="playlist-details">
          ...
          <p className="browse-meta">{positionen.length} Videos · {daten.anzahl_archiviert} archiviert ({prozent(anteil)})</p>
